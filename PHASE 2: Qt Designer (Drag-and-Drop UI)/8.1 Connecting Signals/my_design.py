...
################################################################################
## Form generated from reading UI file 'mydesign.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout1.addWidget(self.name_label)

        self.blank_name = QLineEdit(self.centralwidget)
        self.blank_name.setObjectName(u"blank_name")

        self.horizontalLayout1.addWidget(self.blank_name)
        ...
        self.menubar.setGeometry(QRect(0, 0, 336, 24))
        ...
        self.enter_button.clicked.connect(self.output.clear)
